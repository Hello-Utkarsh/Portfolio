  ...
  return (
    <AnimatePresence mode="wait"> {page === 'project' && (
      <motion.div
        ...
        transition={{ duration: 1 }} className="h-9/12 w-8/12 absolute z-10 top-[12.5%] p-2 rounded-xl shadow-[0px_4px_16px_rgba(107,114,128,0.3),0px_8px_24px_rgba(107,114,128,0.3),0px_16px_56px_rgba(107,114,128,0.3)]" style={{ backgroundColor: theme[selected].bgColor }}>
        ...
        <ProjectCarousel theme={selected} />
      </motion.div>)}
    </AnimatePresence>
  )
}